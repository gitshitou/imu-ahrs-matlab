...
static void main_ekf_6dof(void);
...
static void main_ekf_6dof(void)
{
  ...
  /* Initialize function 'ekf_6dof' input arguments. */
  /* Initialize function input argument 'TX'. */
  /* Call the entry-point 'ekf_6dof'. */
  argInit_4x1_real32_T(fv1);
  ekf_6dof(argInit_real32_T(), argInit_real32_T(), argInit_real32_T(),
           argInit_real32_T(), argInit_real32_T(), argInit_real32_T(),
           argInit_real32_T(), fv1, y);
}
