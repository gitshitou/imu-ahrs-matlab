...
F1 = [1 ,-0.5*dt*gx, -0.5*dt*gy ,-0.5*dt*gz; 0.5*dt*gx ,1, 0.5*dt*gz ,-0.5*dt*gy;  0.5*dt*gy ,-0.5*dt*gz, 1 ,0.5*dt*gx;0.5*dt*gz ,0.5*dt*gy, -0.5*dt*gx ,1];
...
magDnew = magD;
%状态量合并
stateVector =[quat ;g_b ;magN;magE;magD];
newStateVector =[quatNew;g_bNew;magNnew;magEnew;magDnew];
